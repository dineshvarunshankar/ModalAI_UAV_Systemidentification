#starling 2 Max
python analyze_sweep.py data/starling2_max/starling2max_sweep_2026-05-26_201318_prev.csv --out analysis/starling2_max --mass-kg 0.125
...
python analyze_sweep.py data/starling2_defaultrotor/starling2_sweep_2026-05-27_212140.csv --out analysis/starling2_defaultrotor --mass-kg 0.075
...
python analyze_sweep.py data/starling2_customrotor/starling2_sweep_2026-05-27_214436.csv --out analysis/starling2_customrotor --mass-kg 0.075
